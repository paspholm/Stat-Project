...
=======
# read in data
season_data = read.csv("understat.com.csv")

>>>>>>> ab17a761af37e533b9738acfa8a0fdf331da476c
```
...
drop = c("X", "X.1", "position", "team", "matches", "draws", "loses", "goals", "xG_diff", "xGA_diff", "xpts", "xpts_diff")
...
set.seed(123)
season_data_clean <- vfold_cv(season_data_clean, v = 9)
```
